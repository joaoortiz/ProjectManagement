 <nav class="navbar navbar-expand-lg bg-primary-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link text-white" href="ListaTarefasUI.php">Minhas Tarefas</a>
                    <a class="nav-item nav-link text-white" href="../Control/UsuariosControl.php?acao=3">Sair</a>
